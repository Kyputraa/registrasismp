        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="home.php"><img src="images/logo.png" alt="Hair Salon Website Templates Free Download"></a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <p class="hero-text"><strong>Selamat datang di website kami</strong> 
                     </p>
